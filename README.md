📊 Health Plan Benefits, Cost Sharing & Network Analysis
🧠 Project Overview

This project analyzes health insurance plans by combining information on benefits, cost-sharing structures, and provider networks.
The goal is to understand how plan design elements interact and how they may impact accessibility, affordability, and value for beneficiaries.

A merged dataset was created to enable a unified analysis across these dimensions.
...
⚠️ Due to GitHub file size limitations, the full merged dataset is not included.
